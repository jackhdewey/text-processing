  ...
  plugin.trial = function(display_element, trial) {
    ...
    function createCaptcha() {
      ...
      for (i = 0; i < lengthOtp; i++) {
        ...
        font_sizes.push(get_random_value(["80px", "90px", "100px", "110px", "120px"]));
...
//    '</div></div><input type="text" placeholder="Captcha" id="captchaTextBox" style="padding: 12px 20px; display: inline-block; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;"/>'
        captcha_text ='<div class="container" style="position: relative; text-align: center"><img src="images/checkerboard.jpg" style="width:50%; filter: blur(5px);"><div class="centered" style="position: absolute; top: 30%; left: 35%;"><p><span style="color: transparent; text-shadow: 0 0 6px rgba(0,0,0,'+font_blur[1]+');font-size: '+font_sizes[1]+'; font-family: '+font_families[1]+'; font-weight: '+font_weights[1]+'">'+captcha[1]+'</span><span style="color: transparent; text-shadow: 0 0 6px rgba(0,0,0,'+font_blur[2]+'); font-size: '+font_sizes[2]+'; font-family: '+font_families[2]+'; font-weight: '+font_weights[2]+'">'+captcha[2]+'</span></p>' +
    '</div></div><p>Are you human?  Please enter the digits above.</p><input type="text" placeholder="Captcha" id="captchaTextBox" style="padding: 12px 20px; display: inline-block; border: 1px solid #ccc; border-radius: 4px; box-sizing: border-box;"/>'
        // create form
