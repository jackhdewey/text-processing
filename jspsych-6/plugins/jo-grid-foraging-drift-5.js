...
jsPsych.plugins['forage-grid'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // Get x values
    var sample_x = [1, 4, 7];//spacedRandArray(1, 6, 2, num_pools);
    shuffle(sample_x);
...
//    var rand_x4 = sample_x[3];
    ...
    // Get y values
    var sample_y = [3, 5, 7];//spacedRandArray(2, 6, 1, num_pools);
    shuffle(sample_y);
...
//    var center4 = [rand_x4, rand_y4];
    ...
    for (i=0; i<num_pools; i++){
        ...
        var pool_inner = [[loc_center[0], loc_center[1]-1], [loc_center[0]+1, loc_center[1]-1],
                            [loc_center[0], loc_center[1]], [loc_center[0]+1, loc_center[1]]];
...
//                display_element.querySelector('#success_text').setAttribute("style", "display: block; position: absolute; background-color: #4CAF50; border: none; color: white; padding: 12px 30px; text-decoration: none; top: 10%; left: 30%");
                ...
                curr_points = 0;
                subj_score += 0;
                display_element.querySelector('#fail_text').innerHTML = "Oops, try a different area!";
