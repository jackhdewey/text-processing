...
//                height="${h * .97}"
        ...
        `<div id='jspsych-video-start-wrapper' style='display:block; border-radius: 4px; padding: 10px 10px 20px 20px; background-color: white; width: ${instruct_size}px; position: absolute; top: 10%; left: ${left_center}px'>
           ...
           Each time, you will first see a plus <b>(+)</b> sign at the center of the screen, and your task is to look at this central point.  You will then see many L- and T-shapes distributed across the table.  Most of these will be L-shaped objects, and each time, there will always be a <b>one T-shaped object</b> (in the image below, the T-shaped object has been circled for you).<p><img src='images/sample_display2.png' width=60%></img></p>
        ...
        `<div id='jspsych-video-start-wrapper' style='display:block; border-radius: 4px; padding: 10px 10px 20px 20px; background-color: white; width: ${instruct_size}px; position: absolute; top: 10%; left: ${left_center}px'>Your task is to search for the T-shaped object and press the <b>F KEY</b> if it is facing the left, and the <b>J KEY</b> if it is facing the right.<br>
            ...
            <div>
            <div style='left: ${left_center}px'><img src='images/white-left-T-sample.png' width=5%></img>
            <p class='small'><strong>Press the F key</strong></p></div>
            <div class='left: ${left_center}px'><img src='images/white-right-T-sample.png' width=5%></img>
