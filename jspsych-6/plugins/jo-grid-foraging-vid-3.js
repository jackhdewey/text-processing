...
//            console.log("adding food")
    ...
    display_element.innerHTML += "<div id='foraging_display' style='display: none'>Your score: <span id='score_text'>"+subj_score+"</span><br>Food available: <span id='food_text'>"+food_count+"</span></div>" + "<div id='canvas_display' style='display: none;'>"+"<canvas id='myCanvas' width='"+trial.canvas_size[0]+"' height='"+trial.canvas_size[1]+"'></canvas>"+"</div>"+"</div>";
