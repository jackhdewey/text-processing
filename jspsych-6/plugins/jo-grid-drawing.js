...
jsPsych.plugins['draw-grid'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      prompt: {
        ...
        default: '<p>Draw the shape or pattern you saw.<br>You can click on the <strong>SUBMIT</strong> button when you finish drawing a shape.<br>You can submit as many as you want, and when you have drawn all the shapes you think you can see, press the <strong>Q key</strong> to exit.</p>',
  ...
  plugin.trial = function(display_element, trial) {
    if (trial.allow_drawing == true){
        display_element.innerHTML = trial.prompt + "<div style='align:center; margin: 0 auto'>"+"<canvas id='myCanvas' width='"+trial.canvas_size[0]+"' height='"+trial.canvas_size[1]+"'></canvas>"+"</div>";
    ...
    if (trial.allow_drawing){
        ...
        canvas.addEventListener('mousemove', function(evt) {
            ...
            if(draw_mode == true)
            {
            fillBlock(context,mousePos.x,mousePos.y);
            }
        }, false);
        ...
        // canvas_hammer.on("panstart", function(ev) {
        //   console.log('start');
        //   draw_mode = true;
        // });
        // canvas_hammer.on("panend", function(ev) {
        //   draw_mode = false;
        //    console.log('end');
        //   // draw_seq.push(draw_data);
        //   // draw_data = [];
        // });
