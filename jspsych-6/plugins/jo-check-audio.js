...
jsPsych.plugins['check-audio'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    // add blank warning
    html += '<div id="jspsych-survey-html-form-warning" style="display: none"><p style="color: red">Sorry, you indicated the wrong number of notes. You will now be redirected so you can try again.</p></div>';

    // add form HTML / input elements
    html += '<p>You just heard a number of tones of the same pitch play one after another.  How many individual tones played?<br><input name="notes" type="number" style="width: 20%; border-radius: 4px; padding: 10px 10px; margin: 8px 0; border: 1px solid #ccc; font-size: 15px"/></p>';
    ...
    display_element.querySelector('#jspsych-survey-html-form').addEventListener('submit', function(event) {
      ...
      if (trial.check_blanks){
          ...
          if (respObj["notes"] !== '3'){ blankDetected = true;}
          ...
          if (blankDetected == false) {
            ...
            setTimeout(function(){ jsPsych.finishTrial(trialdata);}, 3000);
          }
      } else {
          // save data
          var trialdata = {
