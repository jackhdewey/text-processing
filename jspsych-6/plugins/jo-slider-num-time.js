...
jsPsych.plugins['slider-num-time'] = (function() {

  var plugin = {};

  plugin.info = {
    name: 'slider-num-time',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.show_slider){
        ...
        // add warning
        html += '<div id="jspsych-survey-html-form-warning" style="display: none"><p style="color: red">Oops: In the previous section, you reported seeing shapes and patterns on the grid.  Please now respond with a value greater than 0, reflecting how long you saw any shape or pattern.</p></div>';
        ...
        display_element.querySelector('#jspsych-html-slider-response-next').addEventListener('click', function() {
          ...
          if(trial.response_ends_trial && errorDetected == false){
            end_trial();
          } else {
    ...
    } else { display_element.innerHTML = html;}
