let text1cloze =
            ...
            "<p id='p1'>The seeds of this story were planted in a steaming pile of elephant dung somewhere in the African savanna. Elephants love to stuff their faces with fruit, and fruit trees like %marulas% need a way to spread their seeds, so the two species have developed an intimate and symbiotic relationship. A single African savanna elephant is capable of dumping seeds up to %65% kilometers from the site of its feast, making them the most impressive seed transporters in the animal kingdom." +
            ...
            "<p id='p11'>Plants and animals are undertaking epic journeys as the planet warms. %Atlantic cod and a species of butterfly% in Europe, for example, have each migrated more than %200% kilometers in just 10 years or less, National Geographic’s Craig Welch reports. Meanwhile, large numbers of %Atlantic mackerel% have moved all the way from waters near the UK and Scandinavia to Iceland, spurring geopolitical tensions related to fishing rights. In the US and elsewhere, ticks and other pests are marching into new territory, too." +

            "<p id='p12'>Plants are likewise finding new places to put down roots. In the last half-century, the line where trees stop growing has moved roughly %150% meters higher in the Altai Mountains of %Central and East Asia%, where the temperature has increased by as much as 1.7 degrees Celsius. By the end of the century many species of %sugar maples%, which produce %maple syrup%, could move north by as much as 200 kilometers, according to the US Forest Service. Not all plants and animals are moving toward the cooler temperatures of the poles; some are chasing rainfall or competing with other species, which is why some mountain plants are actually moving downhill.</p>" +
